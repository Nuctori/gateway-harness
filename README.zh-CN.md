...
- JSON Schema。
- CLI：`validate`、`explain`、`schema`、`dry-run-policy`、`validate-adapter`、`explain-adapter`、`adapter-schema`、`validate-conformance`、`explain-conformance`、`replay-conformance`、`conformance-schema`、`validate-ledger`、`explain-ledger`、`ledger-schema`、`validate-steward`、`explain-steward`、`steward-schema`、`validate-steward-proposal`、`explain-steward-proposal`、`steward-proposal-schema`、`dry-run-steward-proposal`。
