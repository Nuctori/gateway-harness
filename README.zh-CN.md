...
- JSON Schema。
- CLI：`validate`、`explain`、`schema`、`validate-adapter`、`explain-adapter`、`adapter-schema`、`validate-conformance`、`explain-conformance`、`replay-conformance`、`conformance-schema`、`validate-ledger`、`explain-ledger`、`ledger-schema`。
