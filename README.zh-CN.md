...
- JSON Schema。
- CLI：`validate`、`explain`、`schema`、`validate-rule`、`explain-rule`、`compile-rule`、`compile-rule-stewards`、`rule-schema`、`dry-run-policy`、`validate-adapter`、`explain-adapter`、`adapter-schema`、`validate-conformance`、`explain-conformance`、`replay-conformance`、`replay-policy-conformance`、`conformance-schema`、`validate-ledger`、`explain-ledger`、`query-ledger`、`append-ledger-record`、`ledger-schema`、`ledger-record-schema`、`validate-steward`、`explain-steward`、`steward-schema`、`steward-event-schema`、`validate-steward-event`、`run-steward`、`validate-steward-proposal`、`explain-steward-proposal`、`steward-proposal-schema`、`dry-run-steward-proposal`。
